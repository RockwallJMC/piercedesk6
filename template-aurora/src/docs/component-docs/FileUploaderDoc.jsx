      ...
      <DocSection title="FileDropZone">
        ...
        >
          ...
          <DocList>
            ...
            <ListItem>
              <ListItemText disableTypography>
                <Code>{`onRemove: (index) => void`}</Code>: Callback function triggered when a file
                is removed from the preview list or grid.
              </ListItemText>
            </ListItem>
            <ListItem>
              <ListItemText disableTypography>
                <Code>{`defaultFiles`}</Code>: Array of initial files to be displayed in the preview
                before any files are dropped by the user.
              </ListItemText>
            </ListItem>
            <ListItem>
              <ListItemText disableTypography>
                <Code>{`error`}</Code>: Error message displayed beneath the dropzone when there's an
                issue with the uploaded file(s).
              </ListItemText>
            </ListItem>
            <ListItem>
              <ListItemText disableTypography>
      ...
      <DocSection title="FileDropBox">
        ...
        >
          ...
          <DocList>
            ...
            <ListItem>
              <ListItemText disableTypography>
                <Code>{`error`}</Code>: Indicates whether an error has occurred. When set to true,
                changes the drop area style to show an error.
              </ListItemText>
            </ListItem>
            <ListItem>
              <ListItemText disableTypography>
      ...
      <DocSection title="AvatarDropBox">
        ...
        >
          ...
          <DocList>
            <ListItem>
              <ListItemText disableTypography>
                <Code>{`defaultFile`}</Code>: A initial file to be displayed in the preview before
                any file is dropped by the user.
              </ListItemText>
            </ListItem>
            <ListItem>
              <ListItemText disableTypography>
