...
VALUES
  ('34000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', '33000000-0000-0000-0000-000000000001', 'PROP-2026-0001', 'Global Bank HQ Security - Proposal', 'sent', 250000.00, 'USD', '2026-02-28', 'a2222222-2222-2222-2222-222222222222', now(), now()),
  ('34000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', '33000000-0000-0000-0000-000000000003', 'PROP-2026-0002', 'TechVentures Data Center - Proposal', 'draft', 320000.00, 'USD', '2026-03-15', 'a3333333-3333-3333-3333-333333333333', now(), now())
ON CONFLICT (id) DO UPDATE SET
