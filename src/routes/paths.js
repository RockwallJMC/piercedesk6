...
const paths = {
  ...
  crmDashboard: `/${rootPaths.appsRoot}/${rootPaths.crmRoot}/dashboard`,
  ...
  opportunities: `/${rootPaths.appsRoot}/${rootPaths.crmRoot}/opportunities`,
  opportunityList: `/${rootPaths.appsRoot}/${rootPaths.crmRoot}/opportunities/list`,
  opportunityDetail: (id) => `/${rootPaths.appsRoot}/${rootPaths.crmRoot}/opportunities/${id}`,
  opportunityForecast: `/${rootPaths.appsRoot}/${rootPaths.crmRoot}/opportunities/forecast`,
  crmAccounts: `/${rootPaths.appsRoot}/${rootPaths.crmRoot}/accounts`,
